...
var Infinite = React.createClass({
  ...
  generateComputedProps: function generateComputedProps(props) {
    ...
    var elem = props.customScrollContainer || window;
    newProps.containerHeight = props.useWindowAsScrollContainer || props.customScrollContainer ? elem.innerHeight : containerHeight;
  ...
  generateComputedUtilityFunctions: function generateComputedUtilityFunctions(props) {
    ...
    if (props.useWindowAsScrollContainer || props.customScrollContainer) {
      utilities.subscribeToScrollListener = function () {
        elem.addEventListener('scroll', _this.infiniteHandleScroll);
      };
      utilities.unsubscribeFromScrollListener = function () {
        elem.removeEventListener('scroll', _this.infiniteHandleScroll);
      };
